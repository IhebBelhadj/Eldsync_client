...
export class AppMenuitemComponent implements OnInit, OnDestroy {
    ...
    itemClick(event: Event) {
        ...
        // custom click handler for "Life Pulse" menu item
        if (this.item.label === 'Life Pulse' && this.item.customClick) {
            this.item.customClick();
        }
        if(this.item.label!=='Life Pulse' && this.item.customClickItems){
            this.item.customClickItems();
        }
